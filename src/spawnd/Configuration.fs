...
(*
#I "/Users/rkayman001/.nuget/packages/nodatime/2.4.5/lib/netstandard2.0/"
#I "/Users/rkayman001/.nuget/packages/fsharpplus/1.1.0-ci00252/lib/netstandard2.0/"
#I "/Users/rkayman001/.nuget/packages/fsharp.data/3.1.1/lib/netstandard2.0/"
#I "/Users/rkayman001/.nuget/packages/fleece.fsharpdata/0.8.0-alpha-3/lib/netstandard2.0/"
#r "NodaTime.dll"
#r "FSharpPlus.dll"
#r "FSharp.Data.dll"
#r "Fleece.FSharpData.dll"
open NodaTime
open FSharpPlus
open FSharp.Data
open Fleece.FSharpData
...
let schedule = {
    alarms =
      [|{ domain = "pwc-apps.com"; name = "Tiger Atom Feed #1"; schedule = Rate { scale = 6L; cadence = Cadence.PerHour };
        ...
        { domain = "pwc-apps.com"; name = "Tiger Atom Feed #2"; schedule = Rate { scale = 10L; cadence = Cadence.Minutes };
        ...
        { domain = "pwc-apps.com"; name = "Tiger Atom Feed #3"
          schedule = Daily { alarm = { time = LocalTime.Noon; zone = DateTimeZoneProviders.Tzdb.GetSystemDefault() }; kind = DailyKind.Weekdays };
          payload = { source = "https://gate.pform.pwc-apps.com:18153"; protocol = "https";
                      format = "xml"; feed = "atom"; recordType = "assignee";
                      batchSize = 100; maxRetries = 3 } };
        { domain = "pwc-apps.com"; name = "Tiger Atom Feed #3"
          schedule = Weekly { alarm = { time = LocalTime.Noon; zone = DateTimeZoneProviders.Tzdb.GetSystemDefault() }; day = IsoDayOfWeek.Friday };
          payload = { source = "https://gate.pform.pwc-apps.com:18153"; protocol = "https";
                      format = "xml"; feed = "atom"; recordType = "assignee";
                      batchSize = 100; maxRetries = 3 } };
        { domain = "pwc-apps.com"; name = "Tiger Atom Feed #3"
          schedule = Fortnightly { alarm = { time = LocalTime.Noon; zone = DateTimeZoneProviders.Tzdb.GetSystemDefault() }; day = IsoDayOfWeek.Saturday };
          payload = { source = "https://gate.pform.pwc-apps.com:18153"; protocol = "https";
                      format = "xml"; feed = "atom"; recordType = "assignee";
                      batchSize = 100; maxRetries = 3 } };
        { domain = "pwc-apps.com"; name = "Tiger Atom Feed #3"
        ...
        { domain = "pwc-apps.com"; name = "Tiger Atom Feed #3"
          schedule = Quarterly { alarm = { time = LocalTime.Noon; zone = DateTimeZoneProviders.Tzdb.GetSystemDefault() };
                                 modifier = DayAdjustmentStrategy.Rigid; date = AnnualDate(3,31); adjustment = DateAdjustmentStrategy.Last };
          payload = { source = "https://gate.pform.pwc-apps.com:18153"; protocol = "https";
                      format = "xml"; feed = "atom"; recordType = "assignee";
                      batchSize = 100; maxRetries = 3 } };
        { domain = "pwc-apps.com"; name = "Tiger Atom Feed #3"
          schedule = SemiAnnually { alarm = { time = LocalTime.Noon; zone = DateTimeZoneProviders.Tzdb.GetSystemDefault() };
                                    modifier = DayAdjustmentStrategy.WorkingDayClosest; date = AnnualDate(2,3); adjustment = DateAdjustmentStrategy.Specific };
          payload = { source = "https://gate.pform.pwc-apps.com:18153"; protocol = "https";
                      format = "xml"; feed = "atom"; recordType = "assignee";
                      batchSize = 100; maxRetries = 3 } };
        { domain = "pwc-apps.com"; name = "Tiger Atom Feed #3"
          schedule = Annually { alarm = { time = LocalTime.Noon; zone = DateTimeZoneProviders.Tzdb.GetSystemDefault() };
                                modifier = DayAdjustmentStrategy.WorkingDayBefore; date = AnnualDate(4,5); adjustment = DateAdjustmentStrategy.Specific };
          payload = { source = "https://gate.pform.pwc-apps.com:18153"; protocol = "https";
                      format = "xml"; feed = "atom"; recordType = "assignee";
                      batchSize = 100; maxRetries = 3 } }
      |] }
